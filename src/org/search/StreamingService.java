...
public interface StreamingService {
     ...
     * @return
     */
    Collection<SearchResult> consultar(String query, Collection<String> configParams);
     ...
     * @return
     */
    Collection<SearchResult> buscar(String query, Collection<String> configParams);
}
